...
if is_truthy(os.getenv("NAUTOBOT_CELLULAR_SOT_USE_IN_MEMORY_SERVICES", "false")):
    CACHES = {  # noqa: F405
        "default": {
            "BACKEND": "django.core.cache.backends.locmem.LocMemCache",
            "LOCATION": "nautobot-cellular-sot-dev",
        }
    }
    CONSTANCE_BACKEND = "constance.backends.memory.MemoryBackend"  # noqa: F405
